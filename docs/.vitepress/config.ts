    ...
    nav: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Leaderboards', link: '/llm/01_leaderboards/' },
      ...
      '/llm/': [
        {
          ...
          items: [
            ...
            { text: 'Leaderboards', link: '/llm/01_leaderboards/' },
            {
              ...
              collapsed: false,
              items: [
                { text: 'Neural Networks', link: '/llm/02_genai_foundations/00_neural_networks/' },
                { text: 'Discriminative AI', link: '/llm/02_genai_foundations/01_descriminative_ai/' },
                {
                  text: 'Generative AI',
                  collapsed: false,
                  items: [
                    { text: 'Overview', link: '/llm/02_genai_foundations/02_generative_ai/' },
                    { text: 'GANs', link: '/llm/02_genai_foundations/02_generative_ai/01_gans/' },
                    { text: 'Diffusers', link: '/llm/02_genai_foundations/02_generative_ai/02_deffuser/' },
                    { text: 'Transformers', link: '/llm/02_genai_foundations/02_generative_ai/03_transformers/' }
                  ]
                }
              ]
            },
